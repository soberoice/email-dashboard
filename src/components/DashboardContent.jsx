      ...
      >
        ...
        <div className="flex-8 my-auto">
          ...
          <p className="text-base">
            Your account has been approved and you can now send up to 100 emails
            per month. Need more? Order a plan by clicking the upgrade button
            below. The free plan includes 3,000 emails per month.
          </p>
          <button
